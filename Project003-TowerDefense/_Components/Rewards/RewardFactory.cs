...
public class RewardFactory
{
    ...
    public RewardFactory()
    {
        ...
        RewardTextures.Add(Rewards.TowerCannon, Globals.Content.Load<Texture2D>("cannon"));
        ...
        RewardTextures.Add(Rewards.Lightning, Globals.Content.Load<Texture2D>("lightning"));
        ...
        RewardTextures.Add(Rewards.Life, Globals.Content.Load<Texture2D>("life"));
        RewardTextures.Add(Rewards.Reroll, Globals.Content.Load<Texture2D>("reroll"));
        ...
        PositiveRewardValues.Add(Rewards.TowerCannon, 2);
        ...
        PositiveRewardValues.Add(Rewards.Lightning, 2);
        PositiveRewardValues.Add(Rewards.Mine, 2);
        PositiveRewardValues.Add(Rewards.Life, 1);
        PositiveRewardValues.Add(Rewards.Reroll, 1);
